...
| winnipeg | TNTP TransportationNetworks, imported 2026-07-31 | research use; best-known flows correspond to a generalized cost (toll factor 0.02 lineage) |
| eastern_massachusetts | TNTP TransportationNetworks, imported 2026-07-31 | research use |
| braess_tntp | TNTP TransportationNetworks Braess-Example | research use |
| austin | TNTP TransportationNetworks (AM trips), imported 2026-07-31 | research use |
| forge/* | Generated by TAPForge (parameters + seed in each manifest.yml) | CC0; fully reproducible from the manifest |
| washington_dc_driving | GMNS_Plus dataset (Global Dataset Project, OSM-derived), SCC-restricted by taplab.converters.import_dc_multimodal | ODbL attribution for OSM-derived geometry; synthetic demand |
| washington_dc_transit | Public GTFS feeds (WMATA 2020-04, DC Circulator 2021-09, DC Streetcar 2021-09) via gtfs2gmns; TAZ centroids from GMNS_Plus | public GTFS; synthetic OD (15% of driving demand) |
